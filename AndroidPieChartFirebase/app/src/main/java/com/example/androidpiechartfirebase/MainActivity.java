...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("piedataPoints");
    ...
    private void submitData() {
        ...
        DataPoints dataPoint = new DataPoints(timestamp, value);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    DataPoints dataPoint = snapshot.getValue(DataPoints.class);
                    if (dataPoint != null) {
                        Log.d(TAG, "onDataChange: Data point fetched - Timestamp: " + dataPoint.getTimestamp() + ", Value: " + dataPoint.getValue());
                        entries.add(new PieEntry(dataPoint.getValue(), String.valueOf(dataPoint.getTimestamp())));
                    }
                }
                PieDataSet dataSet = new PieDataSet(entries, "Data Points");
                PieData pieData = new PieData(dataSet);
                pieChart.setData(pieData);
                pieChart.invalidate(); // refresh
                Log.d(TAG, "onDataChange: Pie chart updated with new data");
            }
